  ...
  ngOnInit() {
    ...
    this.logs.push(new Post({
      ...
      content: `
        ...
        <p><a href="/assets/img/kantar-git-branching-strategy.pdf">http://temich.in.ua/assets/img/kantar-git-branching-strategy.pdf</a></p>
    `}));
    ...
    this.logs.push(new Post({
      ...
      content: `
        ...
        <p><a href="/assets/img/angular2-4kantar.pdf">http://temich.in.ua/assets/img/angular2-4kantar.pdf</a></p>
    `}));
    ...
    this.logs.push(new Post({
      ...
      content: `
        ...
        <p><a href="/assets/img/angular2.pdf">http://temich.in.ua/assets/img/angular2.pdf</a></p>
    `}));
